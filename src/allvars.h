...
#define ICFILE          "output/ic64box16.6667B0.06.h5"  // you can restart from a snapshot too!
//
...
fftw_complex psi[N][N][N];
fftw_complex psihat[N][N][N];
double V[N][N][N];
fftw_complex Vhat[N][N][N/2+1];
